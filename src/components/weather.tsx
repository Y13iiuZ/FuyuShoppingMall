...
const Weather: React.FC<WeatherProps> = ({ temperature=0, info='none',humidity=0,power=0,aqi=0,direct='未知' }) => {
  return (
    <div style={{position:'absolute',height:'100%',right:'9rem',top:'-10rem'}}>
      <div className="weatherCard">
        <div className="mainCard">
          ...
          <div className="mainsub">{info}</div>
        </div>
