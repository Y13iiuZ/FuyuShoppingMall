...
const Me: React.FC = () => {
  return (
    <>
    <div style={{backgroundImage:"url('/mine.png')",height:'100vh',width:'100vw'}}>
      <div className="meCard">
        <button className="meMail">
          <svg
        ...
        <div className="bottom">
          <div className="content">
            <span className="name">张铁曦</span>
            <span className="about-me">
            目前就职于前端开发。我认为前端也离不开算法，不仅是大厂所需，更是培养人的思维能力 <br/>Let&apos;s Dance with the Byte.
            </span>
          </div>
