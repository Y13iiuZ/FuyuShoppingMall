...
export default function commentBtn(props:Props) {
  ...
  return (
      <button className="bookmarkBtn" onClick={handleClick}>
        <span className="IconContainerComment">
          <svg fill="currentColor" viewBox="0 0 512 512" height="1em">
